...
const DesignSystem = () => {
  const colorTokens = [
    ...
    },
    {
      ...
      tokens: [
        { name: "--teal", value: "184 23% 42%", hex: "#548687", usage: "Data/Analytics/Charts" },
    ...
    },
    {
      ...
      tokens: [
        { name: "--gray-very-light", value: "240 20% 96%", hex: "#F4F4F6", usage: "Elevation/Cards" },
        { name: "--gray-light", value: "240 9% 90%", hex: "#E6E6E9", usage: "Foundation/Background" },
      ]
    }
  ];
