    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-foreground/90 mb-8 max-w-3xl font-mono">
              ...
              <Card key={study.id} className="console-card h-full">
                <CardHeader>
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-mono text-sm text-foreground/90">{study.id}</span>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-foreground/90 mb-8 font-mono">
