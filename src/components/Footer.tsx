        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12 pb-16 border-b border-white/10">
            ...
            <div className="lg:text-right">
              ...
              <Button asChild size="lg" className="bg-white text-[hsl(var(--burgundy))] hover:bg-white/90 font-mono font-bold uppercase tracking-wider">
          ...
          <div className="grid md:grid-cols-3 gap-12 py-12 border-b border-white/10">
            ...
            <div>
              ...
              <div className="space-y-2.5 pt-6 border-t border-white/10">
                <a href="mailto:hello@cwtstudio.com" className="flex items-center gap-2 text-white/70 hover:text-white transition-colors font-mono text-sm">
