    ...
    <g>
      {type === 'core' ? (
        ...
        <>
          ...
          />
          <polygon
            points={`${x},${y - offset + 10} ${x + offset - 10},${y} ${x},${y + offset - 10} ${x - offset + 10},${y}`}
            fill="none"
            stroke="#fff"
            strokeWidth="0.5"
            opacity="0.2"
...
const SystemMapDesktop = () => (
  <svg viewBox="0 0 1200 600" className="w-full h-full">
    ...
    {/* Nodes */}
    <Node x={150} y={300} label="API Gateway" type="primary" />
    ...
    <Node x={600} y={460} label="Cloud" type="secondary" />
  </svg>
);
